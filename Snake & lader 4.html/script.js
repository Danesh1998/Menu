...
document.querySelector('#pink').style.marginLeft = '0vmin'
document.querySelector('#pink').style.marginTop = '0vmin'
// document.querySelector('#black').style.marginLeft = '0vmin'
// document.querySelector('#black').style.marginTop = '0vmin'
boxNumbers()
...
function changeTurn(){
    if(turn=='blue'){
        document.querySelector('#p_turn').innerHTML = "King"
        turn = 'red'
    }
    else if(turn=='red'){
        document.querySelector('#p_turn').innerHTML = "Queen"
        turn = 'pink'
    }
    else if(turn=='pink'){
        document.querySelector('#p_turn').innerHTML = "police"
        turn = 'blue'
    }
    // else if(turn=='white'){
    //     document.querySelector('#p_turn').innerHTML = "army"
    //     turn = 'blue'
    // }
...
function checkLadderAndSnakes(){
    return new Promise(async(resolve,reject)=>{
    let froms =[[29.4,0],[68.6,-9.8],[58.8,-19.6],[68.6,-29.4],[0,-29.4],[9.8,-39.2],[19.6,-39.2],[88.2,-39.2],[58.8,-49],[9.8,-58.8],[49,-58.8],[58.8,-68.6],[39.2,-68.6],[78.4,-78.4],[9.8,-88.2]]
